...
const Header = ({ allCoins, onAddCoin, isLoading }) => {
  return (
    <header className="flex flex-col md:flex-row items-center justify-between py-6 mb-8 border-b border-border-primary">
      <div className="flex items-center gap-3 mb-4 md:mb-0">
        <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-purple-primary to-accent-hot flex items-center justify-center font-bold text-lg text-white shadow-glow-purple relative overflow-hidden">
        ...
        <div>
          <h1 className="text-2xl font-bold bg-gradient-to-r from-text-primary to-purple-primary text-transparent bg-clip-text">
            PurpDex
          </h1>
          <p className="text-sm text-text-secondary">Crypto Momentum Tracker</p>
        </div>
      </div>
